...
class InteractiveCube(plt.Axes):
    ...
    def _initialize_widgets(self):
        ...
        self._ax_random = self.figure.add_axes([0.55, 0.00, 0.2, 0.075])
        self._btn_random = widgets.Button(self._ax_random, 'Randomise')
        self._btn_random.on_clicked(self._random_cube)
